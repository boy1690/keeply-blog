...
─────────────────────────────────────────────
 ...
 ●  今天 15:30     設計_李事務所       [下載][還原]
    修改蓋板規格

 ●  04/20 10:22    設計_李事務所       [下載][還原]
    避開老舊雨水管

 ●  04/18 09:15    設計_李事務所  ⭐定版

 ●  04/15 17:40    設計_李事務所       [下載][還原]
    斷面調整 40cm
...
─────────────────────────────────────────────
 共享保管庫成員
   ...
   打開資料夾的每個人，看到的是同一條時間線。
   新版進來那一刻，所有人的 Keeply 都會多一條。
```

誠實說：兩張 .dwg 的圖面要比對細節差異，還是得開 AutoCAD 自己看；Keeply 不做 CAD 圖面 diff。但「有沒有新版進來、是誰、什麼時候、你看過沒」這件事不會再漏掉。主管問「你有沒有看過上週四那版」，時間軸一目了然。
