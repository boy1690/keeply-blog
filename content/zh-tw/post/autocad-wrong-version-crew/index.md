---
title: "為什麼給工班的 AutoCAD 圖檔總是給錯：現場拿舊圖、辦公室有新圖、沒人把兩邊接起來"
description: "早上 9:40 你回辦公室，主管翻出上週四的新版圖——蓋板規格早就改了。但你每天在工地，沒人通知你。現場那段水溝剛灌完。這不是傳錯檔，是設計一直改、辦公室收了沒轉告、你沒謹慎回來核對。給工程主任的圖檔版本實戰：不用換工班習慣、不用改作業流程，讓每一次改動的軌跡自己留下來。"
...
早上 9:40，你難得回辦公室一趟，順手把昨天現場的照片滑給後面主管看——排水溝那段混凝土已經灌下去，蓋板也裝了半邊。
...
現場那段已經灌好了。蓋板規格改——要重開預鑄模、重新丈量、重做收邊。工期再往後推兩天。
...
**三、讓工具自動記住每一版、而且全部人都看得到。** 這是前兩步靠意志力做不到、或做不滿的地方，工具補位。[Keeply](https://keeply.work) 就是為這件事設計的。每次存檔自動記一版，檔案不搬家、繼續住在專案資料夾裡。**只要所有人開的是同一個保管庫（通常就是公司 NAS），每個人都看得到同一條時間線**——辦公室存進新版那一刻，你在工地打開，時間軸頂端就多一條「今天 15:30 設計又改了一版」。誠實說：兩張 .dwg 的圖面要比對細節差異，還是得開 AutoCAD 自己看；Keeply 不做 CAD 圖面 diff。但「有沒有新版進來、是誰、什麼時候」這件事不會再漏掉。主管問「你有沒有看過上週四那版」，時間軸一目了然。
...
如果你的辦公室一共就你一個人收件、你每天都在現場、從頭到尾沒人可以漏通知你——那就不會有這個問題。

如果你是純設計、不交施工圖、作品出完就結案，你也不需要這一切。

其他人呢？中小型住宅、透天、外構、排水、景觀、道路、校園、商辦、室內裝修——**只要你辦公室跟現場不是同一個人、設計會改、定案會拖**，你每天都在辦公室跟現場那條斷線上走。每斷一次，時間跟錢都從你口袋出去。
