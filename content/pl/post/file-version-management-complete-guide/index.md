...
2. [30-dniowa historia wersji to kłamstwo](#reason-2)
...
→ Powiązany artykuł: [Dlaczego trzymanie pracy magisterskiej na jednym laptopie to hazard, przed którym nikt nie ostrzega](/pl/post/thesis-single-point-of-failure/)
...
→ Powiązany artykuł: [Ukryty koszt folderów współdzielonych](/pl/post/hidden-cost-shared-folders/)
...
→ Powiązany artykuł: [Kiedy ekipa od AutoCAD wczytała złą wersję](/pl/post/autocad-wrong-version-crew/)
